<template>
          ...
          <form @submit.prevent="submitCustomProject">
            ...
            <div class="mb-3">
              ...
              <div v-if="manual.inverter" class="mt-2 row g-2">
                <div class="col"><input v-model="form.invName" placeholder="Name" class="form-control" /></div>
                <div class="col"><input v-model.number="form.invPeakLoad" placeholder="Peak Load" class="form-control" /></div>
                <div class="col"><input v-model.number="form.invMaxPanels" placeholder="Max Panels" class="form-control" /></div>
                <div class="col"><input v-model.number="form.invBatteryVolt" placeholder="Battery V" class="form-control" /></div>
                <div class="col"><input v-model.number="form.invCost" placeholder="Cost" class="form-control" /></div>
              </div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div v-if="manual.battery" class="mt-2 row g-2">
                <div class="col"><input v-model="form.batName" placeholder="Name" class="form-control" /></div>
                <div class="col"><input v-model.number="form.batCapacity" placeholder="Capacity AH" class="form-control" /></div>
                <div class="col"><input v-model.number="form.batPrice" placeholder="Price" class="form-control" /></div>
                <div class="col"><input v-model.number="form.batEnergy" placeholder="Energy kWh" class="form-control" /></div>
              </div>
            </div>
  ...
  <style scoped>
  .custom-project .card { box-shadow: 0 0 8px rgba(0,0,0,0.1); }
  </style>
